...
| **Format** | Live demonstrations and hands-on examples |
| **Audience** | Students and practitioners |

## Key Topics

- **The VIBE Loop** - Value, Intent, Boundaries, Expression
- **Context-Engineered Prompting** - Translating vibes into structured prompts
